    ...
    <div className="flex flex-col flex-1 items-center justify-center px-6">
      <div className="max-w-sm w-full space-y-8 animate-fade-in">
        <div className="text-center space-y-2">
          ...
          <p className="text-[var(--muted)]">Start tracking your reading life</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-lg border border-[var(--border)] text-[var(--foreground)] font-medium transition-colors hover:bg-[var(--surface)] flex items-center justify-center gap-2"
        >
